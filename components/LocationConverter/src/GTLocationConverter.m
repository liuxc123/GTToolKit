//
//  GTLocationConverter.m
//  GTCatalog
//
//  Created by liuxc on 2018/12/5.
//

#import "GTLocationConverter.h"
...
// gtA = 6378245.0, 1/f = 298.3
// b = a * (1 - f)
// ee = (a^2 - b^2) / a^2;
#define gtA 6378245.0
#define gtEE 0.00669342162296594323

@implementation GTLocationConverter
...
+ (CLLocationCoordinate2D)gcj02Encrypt:(double)ggLat bdLon:(double)ggLon
{
    ...
    magic = 1 - gtEE * magic * magic;
    double sqrtMagic = sqrt(magic);
    dLat = (dLat * 180.0) / ((gtA * (1 - gtEE)) / (magic * sqrtMagic) * M_PI);
    dLon = (dLon * 180.0) / (gtA / sqrtMagic * cos(radLat) * M_PI);
    mgLat = ggLat + dLat;
    mgLon = ggLon + dLon;
