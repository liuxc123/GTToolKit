...
@implementation GTPermissionNet

+ (instancetype)sharedManager
{
    static GTPermissionNet* _sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedInstance = [[GTPermissionNet alloc] init];
...
- (void)listenNetPermisson
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        [GTPermissionData authorizeWithCompletion:^(BOOL granted, BOOL firstTime)
         {
