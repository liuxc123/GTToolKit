...
@property (nonatomic, strong) GTBTCentralManager *centalManager;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    *port = [GTBTPort portWithServiceID:@"180A" characteristicID:@"2A23"];
    GTBTPort *port = [GTBTPort portWithServiceID:service.UUID.UUIDString characteristicID:charac.UUID.UUIDString];
    
    char *s = "hello this is GTBluetooth, welcome to use! hello this is GTBluetooth, welcome to use! hello this is GTBluetooth, welcome to use! hello this is GTBluetooth, welcome to use! hello this is GTBluetooth, welcome to use! hello this is GTBluetooth, welcome to use! hello this is GTBluetooth, welcome to use! hello this is GTBluetooth, welcome to use!";
